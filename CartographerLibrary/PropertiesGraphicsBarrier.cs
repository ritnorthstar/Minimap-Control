...
namespace CartographerLibrary
{
    ...
    /// </summary>
    public class PropertiesGraphicsBarrier : PropertiesGraphicsBase
    {
        private double left;
        private double top;
        ...
        public PropertiesGraphicsBarrier() { }

        public PropertiesGraphicsBarrier(GraphicsBarrier rectangle)
        {
            if (rectangle == null)
            {
        ...
        {
            GraphicsBase b = new GraphicsBarrier(left, top, right, bottom, lineWidth, objectColor, actualScale);
