...
namespace CartographerLibrary
{
    ...
    /// </summary>
    public class PropertiesGraphicsBeacon : PropertiesGraphicsBase
    {
        private double left;
        private double top;
        ...
        public PropertiesGraphicsBeacon()
        {

        }

        public PropertiesGraphicsBeacon(GraphicsBeacon ellipse)
        {
            if (ellipse == null)
            {
        ...
        {
            GraphicsBase b =  new GraphicsBeacon(left, top, right, bottom, lineWidth, objectColor, actualScale);
