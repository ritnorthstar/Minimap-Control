using DataTypes;
using Northstar.Minimap.Control.Server.Models;
using System;
...
namespace Northstar.Minimap.Control.Server.Controllers
{
    public class MapsController : ApiController
    {
        private static IMapRepository repository = new LocalMapRepository();
